...
var deString = document.getElementById('definitions');
...
form.onsubmit = function () {
    ...
    GetWords(text)
        ...
        defintions.forEach(function (d) {
            deString.innerHTML += "<p>".concat(counter, ". ").concat(d, "</p>");
            counter++;
        });
    })["catch"](function (_) {
        deString.innerHTML += "<p class=\"lead\">".concat(text, " isn't a word dumdum.</p>");
    });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    return [4 /*yield*/, (0, node_fetch_1["default"])(URL + text, {
                            method: 'GET',
                            headers: {
